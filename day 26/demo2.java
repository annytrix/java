public class demo2 {
    public static void main(String[] args) {
        ...
        String s1 = new String("Anny Singh");
       ...
       // System.out.println(s1.charAt(2));
        //char[] arr = s1.toCharArray(); // {'A', 'n', 'n', 'y','s', 'i', 'n', 'g', 'h'}
        ...
        // System.out.println(s1.startsWith("Anny")); // true
        // System.out.println(s1.endsWith("Singh")); // true
        ...
        // String s3 = "Anny Singh-Ram-mohan";
        // String[] arr = s3.split("-");
        ...
        // format
        String name = "Anny Singh";
        int age = 28;

        // Hello Anny Singh, your age is 28;
